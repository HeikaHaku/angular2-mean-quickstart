# Angular2 MEAN Quickstart [![Build Status](https://travis-ci.org/HeikaHaku/angular2-mean-quickstart.svg?branch=unstable)](https://travis-ci.org/HeikaHaku/angular2-mean-quickstart)
